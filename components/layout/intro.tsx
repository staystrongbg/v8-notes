  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#f5f7fb] via-white to-[#eef2ff] text-slate-900 dark:from-[#05060a] dark:via-[#0b1120] dark:to-[#05060a] dark:text-white">
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-4xl flex-col items-center justify-center px-6 py-24 text-center">
        <p className="mb-4 text-xs uppercase tracking-[0.8em] text-cyan-700/60 dark:text-cyan-200/80">
          Signal ϟ Online
        </p>
        <h1 className="bg-gradient-to-r from-sky-500 via-indigo-500 to-fuchsia-500 bg-clip-text text-6xl font-black tracking-wide text-transparent drop-shadow-[0_0_18px_rgba(79,70,229,0.35)] dark:from-cyan-200 dark:via-sky-400 dark:to-purple-400 dark:drop-shadow-[0_0_18px_rgba(56,189,248,0.65)] sm:text-7xl">
          Cyber
          <span className="ml-4 inline-flex animate-[pulse_3s_ease-in-out_infinite] text-slate-900 dark:text-white">
            Notes
          </span>
        </h1>
        <p className="mt-6 max-w-2xl text-base text-slate-600/80 dark:text-slate-200/80">
        ...
        <div className="mt-10 flex flex-col items-center gap-6 text-sm text-slate-700 sm:flex-row dark:text-cyan-100/80">
          ...
          <span className="inline-flex items-center gap-2 text-fuchsia-500 dark:text-purple-200">
